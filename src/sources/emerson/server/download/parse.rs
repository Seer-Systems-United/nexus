...
pub(crate) struct ReleaseStub {
    pub(crate) article_url: String,
    pub(crate) date: String,
    pub(crate) published_on: SimpleDate,
}

pub(crate) fn parse_release_stubs(html: &str) -> Result<Vec<ReleaseStub>, super::DynError> {
...
pub(crate) fn parse_release_details(html: &str) -> Result<ReleaseDetails, super::DynError> {
    let document = Html::parse_document(html);
